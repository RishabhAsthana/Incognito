    ...
    <Grid.Row>
      <Grid.Column width={8}>
            ...
            <Grid.Row>
             ...
             <Grid.Row>
                    <Header size='huge'>Threads for CS 357</Header>
            </Grid.Row>
             <Grid.Row  >
                 <ThreadList/>
            </Grid.Row>
...
const ThreadList = () => (
  <List divided verticalAlign='middle' size='huge' style={{height:"450px"}} >
    ...
    <Grid columns={2}>
      ...
      <List.Content>
        <List.Header as='a'>Grade not show up on UIUC Enterprise</List.Header>
      </List.Content>
        </Grid.Column>
    ...
    <Grid columns={2}>
      <Grid.Column width={11}>
      <List.Content>
        <List.Header as='a'>Make the Practice Final similar to the in-class flows</List.Header>
      </List.Content>
        </Grid.Column>
    ...
    <Grid columns={2}>
      <Grid.Column width={11}>
      <List.Content>
        <List.Header as='a'>Homework 9 disappeared</List.Header>
      </List.Content>
        </Grid.Column>
    ...
    <Grid columns={2}>
      <Grid.Column width={11}>
      <List.Content>
        <List.Header as='a'>Release Format of Final Exam</List.Header>
      </List.Content>
        </Grid.Column>
    ...
    <Grid columns={2}>
      <Grid.Column width={11}>
      <List.Content>
        <List.Header as='a'>Midterm grades are wrong!</List.Header>
      </List.Content>
        </Grid.Column>
